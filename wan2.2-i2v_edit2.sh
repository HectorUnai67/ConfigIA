    ...
    read -r -d '' workflow_json << 'WORKFLOW_JSON' || true
{
  ...
  "nodes": [
    ...
    },
    {
      ...
      "properties": {
        ...
        "models": [
          {
            "name": "Wan_2_2_I2V_A14B_HIGH_lightx2v_4step_lora_v1030_rank_64_bf16.safetensors",
            "url": "https://huggingface.co/Comfy-Org/Wan_2.2_ComfyUI_Repackaged/resolve/main/split_files/loras/extras/Wan_2_2_I2V_A14B_HIGH_lightx2v_4step_lora_v1030_rank_64_bf16.safetensors",
            "directory": "loras"
          }
        ],
        "ue_properties": {
    ...
    },
    {
      ...
      "properties": {
        ...
        "models": [
          {
            "name": "wan2.2_i2v_A14b_low_noise_lora_rank64_lightx2v_4step_1022.safetensors",
            "url": "https://huggingface.co/Comfy-Org/Wan_2.2_ComfyUI_Repackaged/resolve/main/split_files/loras/extras/wan2.2_i2v_A14b_low_noise_lora_rank64_lightx2v_4step_1022.safetensors",
            "directory": "loras"
          }
        ],
        "ue_properties": {
  ...
  "config": {},
  "extra": {
    "ds": {"scale": 0.658845000000001, "offset": [571.0362391332789, 439.08728925161927]},
    ...
    read -r -d '' workflow_json << 'WORKFLOW_API_JSON' || true
{
  ...
  "85": {
    "inputs": {"add_noise": "disable", "noise_seed": 0, "steps": 4, "cfg": 1, "sampler_name": "euler",
    ...
    "class_type": "KSamplerAdvanced", "_meta": {"title": "KSampler (Advanced)"}
  },
  "86": {
    "inputs": {"add_noise": "enable", "noise_seed": "__RANDOM_INT__", "steps": 4, "cfg": 1,
  ...
  "89": {
    "inputs": {"text": "色调艳丽，过曝，静态，细节模糊不清，字幕，风格，作品，画作，画面，静止，整体发灰，最差质量，低质量，JPEG压缩残留，丑陋的，残缺的，多余的手指，画得不好的手部，画得不好的脸部，畸形的，毁容的，形态畸形的肢体，手指融合，静止不动的画面，杂乱的背景，三条腿，背景人很多，倒着走", "clip": ["84", 0]},
  ...
  "93": {
    "inputs": {"text": "The white dragon warrior stands still, eyes full of determination and strength. The camera slowly moves closer or circles around the warrior, highlighting the powerful presence and heroic spirit of the character.", "clip": ["84", 0]},
  ...
  "97": {
    "inputs": {"image": "https://raw.githubusercontent.com/Comfy-Org/example_workflows/refs/heads/main/video/wan/2.2/input.jpg"},
  ...
  "98": {
    ...
    "class_type": "WanImageToVideo", "_meta": {"title": "WanImageToVideo"}
  },
  "101": {
    "inputs": {"lora_name": "wan2.2_i2v_lightx2v_4steps_lora_v1_high_noise.safetensors", "strength_model": 1.0, "model": ["95", 0]},
    "class_type": "LoraLoaderModelOnly", "_meta": {"title": "LoraLoaderModelOnly"}
  },
  "102": {
    "inputs": {"lora_name": "wan2.2_i2v_lightx2v_4steps_lora_v1_low_noise.safetensors", "strength_model": 1.0, "model": ["96", 0]},
    "class_type": "LoraLoaderModelOnly", "_meta": {"title": "LoraLoaderModelOnly"}
  },
  "103": {
    "inputs": {"shift": 5.0, "model": ["102", 0]},
    "class_type": "ModelSamplingSD3", "_meta": {"title": "ModelSamplingSD3"}
  },
  "104": {
  ...
  "108": {
    "inputs": {"filename_prefix": "video/ComfyUI", "format": "auto", "codec": "auto", "video": ["94", 0]},
